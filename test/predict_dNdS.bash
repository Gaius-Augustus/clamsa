#!/usr/bin/bash
#
# This is an example prediction for the sitewise dNdS values  of the 10 Alignments in ..examples/dNdS_alignments/
...
python ../clamsa.py predict fasta \
   ...
   --use_codons \
   --model_ids '{ "tcmc_dNdS" : "2023.09.18--11.29.27" }' \
   --out_csv dNdS_amniota.csv \
   --sitewise \
