#!/usr/bin/bash
#
# A quick test run for the training of the tcmc_dNds_class model.
# The small test training data (only 10 Alignments) are the tfrecord files in ../data/train_dNdS_class created with clamsa convert from fasta alignments.
...
python ../clamsa.py train ../data/train_dNdS_class/ \
