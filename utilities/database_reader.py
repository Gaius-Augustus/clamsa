...
@tf.function
def parse_tfrecord_entry(entry, num_leaves, alphabet_size, dNdS):  
...
def get_datasets(folder, basename, wanted_splits, num_leaves, alphabet_size, seed = None, buffer_size = 1000, used_compression = True, should_shuffle=False, dNdS = False):
    '''
    ...
    parser = partial(parse_tfrecord_entry, num_leaves = num_leaves, alphabet_size = alphabet_size, dNdS = dNdS)
